...
//
//   - root: every file under [Root] except [UpdateCheckFilename],
//     [AgentSkillsCheckFilename], and [PluginRegistryFilename] is
...
// [UpdateCheckFilename], [AgentSkillsCheckFilename], and [PluginRegistryFilename]. Directories are left alone: the four canonical
...
func pruneRoot() {
	...
	for _, e := range entries {
		...
		if e.Name() == UpdateCheckFilename || e.Name() == AgentSkillsCheckFilename || e.Name() == PluginRegistryFilename {
			continue
		}
