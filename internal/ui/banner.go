...
// iconmark is the Infracost mark rendered in Unicode block elements
// (U+2580–259F). These tile edge-to-edge so the gradient reads as one
// continuous shape rather than a row of disjoint glyphs.
var iconmark = []string{
	"░░▄▟█▙",
	"▄▟  ██",
	"░░  ██",
