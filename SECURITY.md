...
This repository contains the v2 release line of the Infracost CLI. The v1 release line lives in [`infracost/infracost`](https://github.com/infracost/infracost) and is covered by [its own security policy](https://github.com/infracost/infracost/blob/master/SECURITY.md).

The v1 line receives security patches only — bug fixes and new features land here in v2.
